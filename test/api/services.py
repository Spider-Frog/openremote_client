...
class Services:
    ...
    async def get_service(self, service_id = str, instance_id = int, headers: HeaderTypes | None = None) -> ResponseModel[ExternalService]:
        """
        ...
        return ResponseModel(
            ...
            content=ExternalService(**response.json()),
            response=response
        )
    ...
    async def register_global_service(self, headers: HeaderTypes | None = None) -> ResponseModel[ExternalService]:
        """
    ...
    async def register_service(self, headers: HeaderTypes | None = None) -> ResponseModel[ExternalService]:
        """
